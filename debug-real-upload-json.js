/**
 * DEBUG: Real Aptos-Shelby Upload Test (JSON version)
 * 
 * Test script for the new REAL blockchain upload system using JSON
 */
...
async function testRealUploadJSON() {
  console.log('🚀 DEBUG: Testing REAL Aptos-Shelby Upload (JSON)...\n');
  ...
  try {
    ...
    const requestData = {
      file: {
        name: 'debug-real-test.txt',
        type: 'text/plain',
        data: fileBase64
      },
      blobName: 'real-test-' + Date.now(),
      retentionDays: 7,
      wallet: '0x50093856644bfcf8e33e3979b52f1a71f79f24a6ed7da94aa92b5b4057e0d0bb'
    };

    console.log('📤 Sending JSON request to:', API_URL);
    console.log('📋 Request data:');
    console.log('  - blobName:', requestData.blobName);
    console.log('  - retentionDays:', requestData.retentionDays);
    console.log('  - wallet:', requestData.wallet);
